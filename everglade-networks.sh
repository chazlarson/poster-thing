...
LOGOFILE="logos/TV-networks/green-now.png"
FILENAME="tv-now-green"
STROKECOLOR="#30B803"
./everglade-gen.sh -f ${FILENAME} -l ${LOGOFILE} -c ${BGCOLOR} -d ${STROKECOLOR}

LOGOFILE="logos/TV-networks/purple-now.png"
FILENAME="tv-now-purple"
STROKECOLOR="#660099"
./everglade-gen.sh -f ${FILENAME} -l ${LOGOFILE} -c ${BGCOLOR} -d ${STROKECOLOR}

LOGOFILE="logos/TV-networks/hgtv.png"
FILENAME="tv-hgtv"
STROKECOLOR="#0FADC4"
./everglade-gen.sh -f ${FILENAME} -l ${LOGOFILE} -c ${BGCOLOR} -d ${STROKECOLOR}
